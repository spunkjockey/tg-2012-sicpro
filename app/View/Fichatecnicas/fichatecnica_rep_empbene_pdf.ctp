...
$pdf->Cell(0, 10, 'Beneficiarios y empleos generados', 0, false, 'C', 0, '', 0, false, 'T', 'M');
$pdf->Ln(20);
$fill = 0;
$pdf->SetFont('helvetica', '', 11);
$pdf->Cell(160, 10, "Proyectos a cargo de la división de ". $nomdiv, 0, false, 'C', 0, '', 0, false, 'T', 'M');
$pdf->Ln(5);
