	...
	_init : function() {
		...
		var options = $('<td/>').append(
			$('<div />')
				...
				.html('<span class="ui-icon ui-icon-carat-1-e"></span>')
				.css('margin','2px')
				.click(function(){
			...
			$('<div />')
				...
				.addClass('ui-state-default ui-corner-all')
				.html('<span class="ui-icon ui-icon-carat-1-w"></span>')
			...
			$('<div />')
				...
				.addClass('ui-state-default ui-corner-all')
				.html('<span class="ui-icon ui-icon-arrowstop-1-e"></span>')			
				.css('margin','2px').click(function(){
					self.selectall();
				})
		).append(
			$('<div />')
				...
				.addClass('ui-state-default ui-corner-all')
				.html('<span class="ui-icon ui-icon-arrowstop-1-w"></span>')			
				.css('margin','2px').click(function(){
					self.deselectall();
				})
		);
